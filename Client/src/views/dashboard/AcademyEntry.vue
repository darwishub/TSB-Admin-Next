<template>
    <form>
            ...
            <template v-slot:top-content>
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        :disabled="buttonPublishStatus.disabled"
                        :loading="buttonPublishStatus.loading"
                        >
                            <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-5">
                            ...
                            <BaseSelect :options="programGroupList" name="program_group_id" label="Program Group" class="mb-3 w-100"
                                ...
                                :value="programGroupId" />

                            <BaseInput name="url" label="Youtube URL" class="mb-3" placeholder="Enter a Youtube URL here"
                                :is-required="contentType == 0 ? true : false"
                                :ruleValidation='string().required("Please enter a Youtube URL here").matches(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/,"The URL is not Youtube URL")'
                                v-if="(contentType == 0)" /> 
                            
                                <BaseInput name="url" label="URL" class="mb-3" placeholder="Enter the URL here"
                                :is-required="exclusive == false && contentType == 1 ? true : false"
                                type-rule="url"
                                v-if="(exclusive == false && contentType == 1)" /> 
        ...
        <div v-if="(contentType == 1 && exclusive == true)" class="container">
...
const { fetchUserOnboardingData, SubmitAcademyEntry } = useAcademyStore();
...
const onPublish = handleSubmit(async values => {
    ...
    SubmitAcademyEntry(formData).then(() => {
        resetForm();
