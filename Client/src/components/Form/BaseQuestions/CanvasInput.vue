<template>
    <div>
        ...
        <BaseInput :name="`${name}.schema.props.placeholder`" label="Question placeholder"
            placeholder="Enter placeholder here" type="text" type-rule="text" class="mb-3" isRequired />
        <BaseInput :name="`${name}.schema.props.text_button`" label="Button call to action"
