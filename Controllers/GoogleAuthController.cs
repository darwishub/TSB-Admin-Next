...
namespace TheStartupBuddyV3.Controllers
{
    ...
    public class GoogleAuthController : Controller
    {
        ...
        public GoogleAuthController(IHttpContextAccessor accessor, IRepositoryWrapper repository,
        ...
        public async Task<IActionResult> GoogleCallback(string provider_id, string name_user, string role, string? token, short membership_type, string? coupon, short membership_duration, string email, string? programcode, bool skip_trial, string payment_model, bool card_valid)
        {
        ...
        public async Task<IActionResult> GoogleSignIn(string email)
        {
